function [x0,y0,z0,Gxx,Gyy,Gzz] = EKF_direct_diff(pseudodis,BS_num,BS_loc,Ts,Qk,Sigmaxy,Sigmaz,variance_xy,variance_z,DELTA_TK_ORD,FK_ORD,BSdelta_tk_1,BSf_k_1,MSdelta_tk_1,MSf_k_1,real_x,real_y,real_z,MEASURE_NOISE)
%EKF_direct_diff
c=299792458;
